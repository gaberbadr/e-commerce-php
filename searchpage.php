...
if (isset($_POST['search'])) {
    ...
    $data = mysqli_query($con, "SELECT * FROM prod WHERE name LIKE '%$searchname%'");
}
?>
...
<h2>Search for product here</h2>
<form class="d-flex" action="searchpage.php" method="post">
        <input type="search" placeholder="Search for products" name="search-name" value="<?php echo $searchname ?>">
...
<section id="product1" class="section-p1">
      ...
      <?php
      if(mysqli_num_rows($data) > 0  && !empty($searchname)){
      include('config.php');
      ...
      echo "their is no product like you write .";
    }
      ?>
      </div>
</section>
